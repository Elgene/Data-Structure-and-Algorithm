...
public abstract class GUI {
     ...
     */
    public enum Move {
        NORTH, SOUTH, EAST, WEST, ZOOM_IN, ZOOM_OUT, FIND_FASTEST, RESTRICTIONS
    }

    ;

    //************CHANGES HERE
    protected abstract void onMinValueSet(boolean minValue);
    ...
    //CHANGES HERE**********
    protected abstract void searchingPath();
    ...
    //**********CHANGES HERE
    private JComboBox<String> minValue;
    ...
    private void initialise() {
        ...
        //CHANGES HERE*******
        JButton searchingPath = new JButton("Search Path");
        searchingPath.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                searchingPath();
                redraw();
            }
        ...
        restrictions.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                AStarRecord.condition = "Restriction";
                onMove(Move.RESTRICTIONS);
                redraw();
            }
        });
        JButton findFastestRoute = new JButton("Find Fastest Route");
        findFastestRoute.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                AStarRecord.condition = "FindFastest";
        ...
        //CHANGES HERE**********
        controls.add(searchingPath);
        controls.add(new JLabel("Search"));
        controls.add(Box.createRigidArea(new Dimension(5, 0)));
        controls.add(search);
        //**********Changes Here
        controls.add(restrictions);
        controls.add(findFastestRoute);
        ...
        minValue = new JComboBox<>(options);
        ...
        pathOptionsPanel.add(minValue);
        controls.add(pathOptionsPanel);


        minValue.addActionListener((e) -> {
            this.onMinValueSet(minValue.getItemAt(0).equals("Time"));
        });
