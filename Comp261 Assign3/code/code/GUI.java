...
public abstract class GUI {
	...
	protected abstract void findKruskal();
	//protected abstract void findKruskal();
	...
	private void initialise() {
		...
		JButton findArticulationPoints = new JButton("Articulation");
		...
		JButton findKruskal = new JButton("Kruskal");
		findKruskal.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				findKruskal();
				redraw();
			}
